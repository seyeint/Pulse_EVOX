...
active_problem_set = problem_set_basic #problem_set
...
t0 = time.time()
torch.manual_seed(77)  # I already tried afer line 53 x is the seed index from 0 to n_seeds-1
...
for x in range(n_seeds):
    ...
    for i, algo in enumerate(algorithm_list):
        ...
        for j, function in enumerate(active_problem_set):
            ...
            # Store initial elite fitness as first entry
