# pulse15e_nox2.py  ––  KNOCKOUT of P15e: extension capped at the chord (unbounded ladder removed)
    ...
    def step(self):
        ...
        for k in range(self.n_pairs):
            ...
            if self.pair_is_new[k]:
                ...
                c1 = self.population[bi] + 0.5 * u
                c2 = self.population[bi] + u
            else:
