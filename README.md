...
![Walker Walk Visualization](resources/neuroevolution/gifs/WalkerWalk_LinePulse_side.gif)

## Neuroevolution - Cartpole Balance (MJX)

Visualization of a simple MLP evolved with Pulse (EA) to balance a cartpole:

![Cartpole Balance Visualization](resources/neuroevolution/gifs/CartpoleSwingup_LinePulse_fixed.gif)
